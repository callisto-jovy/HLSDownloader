package net.bplaced.abzzezz.hls.m3u8.util;
...
public class HttpsUtils {
    ...
    public static String get(String url, String[]... headers) throws IOException, ParseException {
        String result = "";
    ...
    public static void readHttpResponse(HttpResponse httpResponse)
            throws ParseException, IOException {
        StringBuilder builder = new StringBuilder();
        // 获取响应消息实体
        HttpEntity entity = httpResponse.getEntity();
        // 响应状态
        builder.append("status:").append(httpResponse.getStatusLine().getReasonPhrase());
